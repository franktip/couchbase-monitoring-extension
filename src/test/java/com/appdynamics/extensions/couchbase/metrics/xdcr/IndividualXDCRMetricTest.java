 ...
 public class IndividualXDCRMetricTest {
     ...
     public void xdcrMetricsTest() throws IOException{
         try (MockedStatic<MetricPathUtils> mocked =  Mockito.mockStatic(MetricPathUtils.class)) {    
             ...
             mocked.when(() -> MetricPathUtils.buildMetricPath(Mockito.anyString(), Mockito.anyString(), Mockito.anyString(), Mockito.anyString())).thenReturn("Custom Metrics|CouchBase|Cluster1|xdcr|beer-sample");
