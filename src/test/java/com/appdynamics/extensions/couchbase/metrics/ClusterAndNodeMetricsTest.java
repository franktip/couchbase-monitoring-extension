 ...
 */
 ...
 public class ClusterAndNodeMetricsTest{
     ...
     public void init() throws IOException{
         ...
         // in Mockito, need to use a try-with-resources, so we create the mock in each test 
     }
     ...
     public void clusterAndNodeMetricsTest() throws IOException{
         try (MockedStatic<MetricPathUtils> mocked =  Mockito.mockStatic(MetricPathUtils.class)) {
             ...
             mocked.when(() -> MetricPathUtils.buildMetricPath(Mockito.anyString(),Mockito.anyString())).thenReturn("Custom Metrics|CouchBase|Cluster1|nodes|172.17.0.2;8091");
